...
const UpdateVerduras = () => {
    ...
    const verduraId = location.pathname.split("/")[2]
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          const response = await axios.put('http://localhost:8800/verduras/'+verduraId, formData);
